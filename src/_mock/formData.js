...
export const LiabilityInfo = [
  ...
  { label: 'Amount', name: 'amount', type: 'number', defaultValue: '', isForm: true },
  { label: 'Interest Rate', name: 'interest_rate', type: 'number', defaultValue: '', isForm: true },
  {
    label: 'Currency',
    name: 'currency',
    type: 'select',
  ...
  { label: 'Start Date', name: 'start_date', type: 'date', defaultValue: '', isForm: true },
  { label: 'Due Date', name: 'due_date', type: 'date', defaultValue: '', isForm: true },
  { label: 'Creditor Name', name: 'creditor_name', type: 'text', defaultValue: '', isForm: true },
  {
    label: 'Creditor Contact Info',
    name: 'creditor_contact_info',
    type: 'text',
    defaultValue: '',
    isForm: true,
  },
...
export const AssetsInfo = [
  ...
  { label: 'Purchase Date', name: 'purchase_date', type: 'date', defaultValue: '', isForm: true },
  ...
  { label: 'Description', name: 'description', type: 'textarea', defaultValue: '', isForm: true },
  { label: 'Notes', name: 'notes', type: 'textarea', defaultValue: '', isForm: true },
];
...
export const InvestmentInfo = [
  { label: 'Name', name: 'name', type: 'text', defaultValue: '', isForm: true },
  {
    ...
    options: [
      ...
      { label: 'Exchange Traded Fund', value: 'exchange_traded_fund' },
      { label: 'Retirement Account', value: 'retirement_account' },
  ...
  { label: 'Purchase Date', name: 'purchase_date', type: 'date', defaultValue: '', isForm: true },
  { label: 'Location', name: 'location', type: 'text', defaultValue: '', isForm: true },
  { label: 'Is Liquid', name: 'is_liquid',  type: 'select',
    options: [
      { label: 'Yes', value: true },
      { label: 'No', value: false },
    ], defaultValue: '', isForm: true },
  ...
  {
    label: 'Investment Taxation',
    name: 'investment_taxation',
    type: 'select',
    options: [
      { label: 'Tax Deferred', value: 'tax_deferred' },
      { label: 'Capital Gains', value: 'capital_gains' },
      { label: 'Ordinary Income', value: 'ordinary_income' },
  ...
  {
    label: 'Investment Account Holder',
    name: 'investment_account_holder',
    type: 'text',
    defaultValue: '',
    isForm: true,
  },
  {
    label: 'Investment Account Status',
    name: 'investment_account_status',
    type: 'text',
    defaultValue: '',
    isForm: true,
  },
...
export const InsuranceInfo = [
  ...
  { label: 'Start Date', name: 'start_date', type: 'date', defaultValue: '', isForm: true },
  { label: 'End Date', name: 'end_date', type: 'date', defaultValue: '', isForm: true },
  {
    label: 'Network Type',
    name: 'network_type',
    type: 'select',
