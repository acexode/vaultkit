...
export const EmployeeInfo = [
    ...
    },
    {
        ...
        "type": "select",
        "options": [{label: 'Full-time', value: 'Full time'}, {label: 'Part-Time', value: 'Part-Time'}, {label: 'Contract', value: 'contract'}, {label: 'Temporary', value: 'temporary'}, 
...
export const EducationInfo = [
    ...
    },
    {
        ...
        "type": "select",
        "options": [{label: 'University', value: 'university'}, {label: 'College', value: 'college'}, {label: 'High School', value: 'high_school'}, {label: 'Vocational School', value: 'vocational_school'}, 
...
export const FinancialInfo = [
    ...
    },
    {
        ...
        "type": "select",
        "options": [{label: 'Own', value: 'own'}, {label: 'Rent', value: 'rent'}, {label: 'Mortgage', value: 'mortgage'}, {label: 'Lease', value: 'lease'},
...
export const IdentificationInfo = [
    {
        ...
        "name": "document_type",
        "type": "select",
        "options": [{label: 'Driver\'s License', value: 'drivers_license'}, {label: 'passport', value: 'passport'}, {label: 'Health Card', value: 'health_card'}, {label: 'Citizenship Card', value: 'citizenship_card'},
